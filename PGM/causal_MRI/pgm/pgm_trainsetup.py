...
from .pgm_dataloader import BrainDataset,BrainDataset_Ctrl, BrainDataset_csv
...
def setup_dataloaders(batch, f_id=0, Test=False, Dataset=0) -> Dict[str, DataLoader]:
    ...
    dataloaders = {
        "train": DataLoader(datasets, shuffle=True, drop_last=True, **kwargs),
        "valid": DataLoader(datasets, shuffle=False, **kwargs),
        "test": DataLoader(datasets, shuffle=False, **kwargs)
